        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              Text(MyStrings.signUp,style: TextStyle(fontWeight: FontWeight.bold,fontSize: MediaQuery.of(context).size.height*.04),),
              SizedBox(
                height: MediaQuery.of(context).size.height*.05,
              ),
              CustomTextField(
              ...
              Text(MyStrings.alreadyMember,style: TextStyle(color: MyColors.greyFontClr),)
            ],
          ),
        ),
      ),
